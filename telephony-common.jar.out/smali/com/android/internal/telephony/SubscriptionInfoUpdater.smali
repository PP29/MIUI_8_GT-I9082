...
.method static synthetic access$402(Lcom/android/internal/telephony/SubscriptionInfoUpdater;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/SubscriptionInfoUpdater;
    .param p1, "x1"    # Z
...
.method static synthetic access$500(Lcom/android/internal/telephony/SubscriptionInfoUpdater;)Ljava/util/BitSet;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/SubscriptionInfoUpdater;
...
.method private handleSimLocked(ILjava/lang/String;)V
    ...
    new-instance v5, Lcom/android/internal/telephony/SubscriptionInfoUpdater$QueryIccIdUserObj;

    invoke-direct {v5, p2, p1}, Lcom/android/internal/telephony/SubscriptionInfoUpdater$QueryIccIdUserObj;-><init>(Ljava/lang/String;I)V

    invoke-virtual {p0, v3, p1, v4, v5}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method private update(I)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method private declared-synchronized updateSubscriptionInfoByIccIdInternal(Z)V
    ...
    .line 784
    .restart local v15    # "previousUpdateSimCount":I
    :cond_1d
    const/16 v21, 0x1
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v4, v6}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->updateCarrierServices(ILjava/lang/String;)V
    ...
    invoke-interface {v6, v9}, Lcom/android/internal/telephony/Phone;->setNetworkSelectionModeAutomatic(Landroid/os/Message;)V
    ...
    iget v6, v2, Lcom/android/internal/telephony/SubscriptionInfoUpdater$SetPreferredNwModeMessage;->slotId:I

    iget v7, v2, Lcom/android/internal/telephony/SubscriptionInfoUpdater$SetPreferredNwModeMessage;->subId:I

    iget v8, v2, Lcom/android/internal/telephony/SubscriptionInfoUpdater$SetPreferredNwModeMessage;->networkType:I

    invoke-direct {p0, v6, v7, v8, v9}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->setPreferredNwModeForSlot(IIILandroid/os/Message;)V
    ...
    const-string v7, "EVENT_UPDATE_INSERTED_SIM_COUNT: locked sims: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mLockedSims:Ljava/util/BitSet;
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->hasMessages(I)Z
    ...
    .line 368
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->updateSubscriptionInfoByIccIdInternal(Z)V
    ...
    const-string v7, "update inserted sim count, current sim count: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mCurrentSimCount:I
...
.method public setDefaultDataSubNetworkType(II)V
    ...
    new-instance v18, Lcom/android/internal/telephony/SubscriptionInfoUpdater$SetPreferredNwModeMessage;
