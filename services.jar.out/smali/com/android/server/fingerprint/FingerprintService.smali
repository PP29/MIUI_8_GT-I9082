...
.method private canUseFingerprint(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/fingerprint/FingerprintService;->checkPermission(Ljava/lang/String;)V
    ...
    .line 576
    .local v2, "pid":I
    iget-object v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mKeyguardPackage:Ljava/lang/String;
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/fingerprint/FingerprintService;->isCurrentUserOrProfile(I)Z
    ...
    const-string v7, " ; not a current user or profile"
    ...
    .line 583
    :cond_2
    iget-object v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mAppOps:Landroid/app/AppOpsManager;

    const/16 v7, 0x37

    invoke-virtual {v6, v7, v3, p1}, Landroid/app/AppOpsManager;->noteOp(IILjava/lang/String;)I
    ...
    const-string v7, " ; not in foreground"
    ...
    .line 592
    :cond_4
    iget-boolean v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintManagerRestrictedToSystemAndOwner:Z
    ...
    const-string v7, ") ; fingerprint restricted to system apps."
    ...
    const-string v7, " package not found, not allowing fingerprint access."
