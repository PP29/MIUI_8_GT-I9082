...
.method private updateTcpDelayedAck(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-virtual {v2}, Landroid/net/LinkProperties;->getTcpDelayedAckSegments()I
    ...
    invoke-virtual {v2}, Landroid/net/LinkProperties;->getTcpUserCfg()I

    move-result v1

    .line 1768
    .local v1, "usercfg":I
    iget v2, p0, Lcom/android/server/ConnectivityService;->mCurrentTcpDelayedAckSegments:I
    ...
    :cond_2
    :goto_1
    iget v2, p0, Lcom/android/server/ConnectivityService;->mCurrentTcpUserCfg:I

    if-eq v1, v2, :cond_0

    .line 1780
    :try_start_1
    const-string v2, "/sys/kernel/ipv4/tcp_use_usercfg"
    ...
    .line 1782
    iput v1, p0, Lcom/android/server/ConnectivityService;->mCurrentTcpUserCfg:I
    :try_end_1
