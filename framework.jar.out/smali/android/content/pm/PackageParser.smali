...
.method private parseBaseApk(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    .line 1531
    .local v51, "splitName":Ljava/lang/String;
    ...
    .end local v51    # "splitName":Ljava/lang/String;
    :cond_0
    :goto_1
    return-object v4
    ...
    .end local v60    # "trustedOverlay":Z
    :cond_1
    const/16 v60, 0x0
    ...
    .restart local v60    # "trustedOverlay":Z
    :catch_0
    move-exception v22
    ...
    .restart local v47    # "pkgName":Ljava/lang/String;
    .restart local v51    # "splitName":Ljava/lang/String;
    :cond_2
    ...
    .line 1544
    .local v49, "sa":Landroid/content/res/TypedArray;
    ...
    .line 1555
    .local v52, "str":Ljava/lang/String;
    if-eqz v52, :cond_5
    ...
    .line 1575
    invoke-virtual/range {v49 .. v49}, Landroid/content/res/TypedArray;->recycle()V
    ...
    .line 1589
    .local v55, "supportsSmallScreens":I
    const/16 v54, 0x1

    .line 1590
    .local v54, "supportsNormalScreens":I
    const/16 v53, 0x1

    .line 1591
    .local v53, "supportsLargeScreens":I
    const/16 v56, 0x1

    .line 1592
    .local v56, "supportsXLargeScreens":I
    const/16 v48, 0x1

    .line 1593
    .local v48, "resizeable":I
    const/16 v18, 0x1
    ...
    .line 1603
    .local v57, "tagName":Ljava/lang/String;
    ...
    .line 1749
    .local v59, "targetVers":I
    const/16 v58, 0x0

    .line 1751
    .local v58, "targetCode":Ljava/lang/String;
    const/4 v3, 0x0
    ...
    .line 1753
    .local v62, "val":Landroid/util/TypedValue;
    if-eqz v62, :cond_22
    ...
    .end local v58    # "targetCode":Ljava/lang/String;
    .end local v59    # "targetVers":I
    .end local v62    # "val":Landroid/util/TypedValue;
    :cond_2f
    :goto_b
    invoke-static/range {p2 .. p2}, Lcom/android/internal/util/XmlUtils;->skipCurrentTag(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .restart local v58    # "targetCode":Ljava/lang/String;
    .restart local v59    # "targetVers":I
    .restart local v62    # "val":Landroid/util/TypedValue;
    :cond_30
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .line 1976
    .end local v57    # "tagName":Ljava/lang/String;
    :cond_43
    if-nez v26, :cond_44
    ...
    aget-object v50, v3, v34

    .line 2009
    .local v50, "spi":Landroid/content/pm/PackageParser$SplitPermissionInfo;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .end local v16    # "NS":I
    .end local v34    # "is":I
    .end local v50    # "spi":Landroid/content/pm/PackageParser$SplitPermissionInfo;
    ...
    .restart local v50    # "spi":Landroid/content/pm/PackageParser$SplitPermissionInfo;
    :cond_4b
    const/16 v30, 0x0
...
.method private parseBaseApk(Ljava/io/File;Landroid/content/res/AssetManager;I)Landroid/content/pm/PackageParser$Package;
    ...
    .line 916
    .local v31, "parser":Landroid/content/res/XmlResourceParser;
    :try_start_0
    new-instance v34, Landroid/content/res/Resources;
    ...
    .line 923
    .local v32, "pkg":Landroid/content/pm/PackageParser$Package;
    if-nez v32, :cond_1
    ...
    invoke-interface/range {v31 .. v31}, Landroid/content/res/XmlResourceParser;->getPositionDescription()Ljava/lang/String;
    ...
    .end local v32    # "pkg":Landroid/content/pm/PackageParser$Package;
    :catch_0
    move-exception v25
    ...
    .restart local v32    # "pkg":Landroid/content/pm/PackageParser$Package;
    ...
    .line 938
    .local v30, "overlayTargets":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .end local v30    # "overlayTargets":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v32    # "pkg":Landroid/content/pm/PackageParser$Package;
    :catch_1
    move-exception v25
    ...
    .restart local v28    # "outError":[Ljava/lang/String;
    .restart local v30    # "overlayTargets":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v32    # "pkg":Landroid/content/pm/PackageParser$Package;
    .restart local v34    # "res":Landroid/content/res/Resources;
    :cond_2
    :try_start_5
...
.method private parseSplitApk(Landroid/content/pm/PackageParser$Package;ILandroid/content/res/AssetManager;I)V
    ...
    .local v25, "parser":Landroid/content/res/XmlResourceParser;
    :try_start_0
    new-instance v27, Landroid/content/res/MiuiResources;
